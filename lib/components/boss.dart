...
import 'package:flutter_flame_game/components/bullets/animated_enemy_bullet.dart';
...
class Boss extends SpriteAnimationComponent with HasGameRef, CollisionCallbacks, BulletsMixin, Weapon {
  ...
  _shoot(BulletActionEnum bulletAction) {
    async.Timer(const Duration(seconds: 4), () {
      var timer = async.Timer.periodic(const Duration(milliseconds: 200), (timer) {
        switch (bulletAction) {
